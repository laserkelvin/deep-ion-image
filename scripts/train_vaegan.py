...
from dii.models.base import VAEGAN
...
vae = VAEGAN(train_indices=train_indices, test_indices=test_indices, **vars(args))

logger = pl.loggers.WandbLogger(name="vaegan", project="deep-ion-image")
